...
5. **Use Behavior (Hành vi sử dụng thực tế)**: Điểm trung bình = `3.36` / 5.0
...
- Mối liên hệ **Social Influence → Intention**: Hệ số tương quan Pearson `r = 0.516` (p < 0.001). Áp lực đồng nghiệp và mentor thúc đẩy mạnh mẽ ý định học tập DevOps.
- Mối liên hệ **Facilitating Conditions → Use Behavior**: Hệ số tương quan Pearson `r = 0.578` (p < 0.001).
