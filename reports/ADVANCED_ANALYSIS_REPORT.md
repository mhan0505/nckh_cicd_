...
- **Tổng mẫu nghiên cứu**: 133 sinh viên
- **Nhóm đã thực tế sử dụng CI/CD**: 52 (39.1%)
- **Nhóm chưa từng dùng công cụ CI/CD**: 81 (60.9%)
...
- **Elite Performer**: 16 sinh viên (12.0%)
- **High Performer**: 37 sinh viên (27.8%)
- **Medium Performer**: 26 sinh viên (19.5%)
- **Low Performer**: 54 sinh viên (40.6%)
...
- Mối liên hệ **Self-efficacy → Use Behavior**: Hệ số tương quan Pearson `r = 0.584` (p < 0.001). Cảm xúc tự tin về DevOps ảnh hưởng cực mạnh đến hành vi áp dụng thực tế.
- Mối liên hệ **Social Influence → Intention**: Hệ số tương quan Pearson `r = 0.503` (p < 0.001). Áp lực đồng nghiệp và mentor thúc đẩy mạnh mẽ ý định học tập DevOps.
...
- **Khoảng cách trung bình (Gap)**: `0.42` điểm Likert.
